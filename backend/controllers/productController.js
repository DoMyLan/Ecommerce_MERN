...
// @route   GET /api/products/query/categories
// @access  Public
...
// @route   GET /api/products/query/categories/:categoryName
// @access  Public
...
// @route   GET /api/products/query/brand
// @access  Public
...
// @desc    Fetch all products by category
// @route   GET /api/products/query/brands/:brand
// @access  Public
const getProductsByBrand = asyncHandler(async (req, res) => {
  ...
  const count = await Product.countDocuments({ brand: req.params.brand});
